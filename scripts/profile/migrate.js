...
function createIndexes(db) {
    ...
    const indexes = [
        ...
        // personality_traits 索引
        ['idx_traits_user', 'personality_traits', 'user_id'],

        // insight_relationships 索引
 ...
 * 清理旧数据（可选）
 */
function cleanupOldData(db, force = false) {
    if (!force) {
        console.log('\n⚠️ 跳过数据清理（如需清理，请设置 force = true）');
        return;
    }
